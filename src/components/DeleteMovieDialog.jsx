...
function DeleteMovieDialog({ dialogRef, open = false, id = null, name = "" }) {
  ...
  return (
    ...
    >
      <div className="text-white rounded-2xl bg-dark-06 w-[556px] p-16 relative">
        ...
        <h3 className="font-heading font-bold text-2xl mb-8">Deleting Movie</h3>
        <p className="font-body text-lg mb-12">
          Are you sure you want to delete <b>{name}</b>?
        </p>
        <div className="flex gap-4">
          <Button className="bg-red! w-full text-white" onClick={deleteMovie}>
            Delete
          </Button>
